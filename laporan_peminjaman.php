...
<section class="content">
	<div class="panel">
		<div class="panel-heading">
			<h4>Filter Laporan Peminjaman Buku</h4>
		</div>
		<div class="panel-body">
			<br>		

			<form action="laporan_peminjaman.php" method="POST">
	...
	if (isset($_POST['tgl_dari']) && isset($_POST['tgl_sampai'])) {
		...
		<div class="panel">
			<div class="panel-heading">
				<h2 align="center">Data Laporan Peminjaman Buku Perpustakaan Dari <b><?php echo $dari; ?></b> Sampai <b><?php echo $sampai; ?></b></h2>
			</div>
			<div class="panel-body">			

				<a target="_blank" href="cetak_print_peminjamanbuku.php?dari=<?php echo $dari; ?>&sampai=<?php echo $sampai; ?>" class="btn btn-sm btn-primary"><i class="glyphicon glyphicon-print"></i> CETAK</a>
				<br/>
				<br/>
